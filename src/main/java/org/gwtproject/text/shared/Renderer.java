...
/**
 * An object that can render other objects of a particular type into plain-text form. Allows
...
public interface Renderer<T> {
  ...
  /**
   * Renders {@code object} as plain text, appended directly to {@code appendable}. Should never
   * throw any exceptions except if {@code appendable} throws an {@code IOException}.
   */
